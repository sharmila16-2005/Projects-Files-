...
#         title = Label(self.root,text="Student Managmant System",bd=9,relief=GROOVE,font=("times new roman",45, "bold"),bg="lightgrey")
...
#         Manage_frame.place(x=20,y=120,width=500,height=650)

#         m_title = Label(Manage_frame, text="Manage Student",bg="lightgrey", fg='black', font=('times new roman',35,'bold'))
#         m_title.grid(row=0,columnspan=2 
#                      , pady=20)
       
#         lbl_name = Label(Manage_frame, text='Roll No', bg='lightgrey', fg='black', font=('times new roman', 20, 'bold'))
#         lbl_name.grid(row=1, column=0, pady=10, padx=20, sticky='w')
#         txt_name = Entry(Manage_frame, textvariable=self.Roll_No_var, font=('times new roman', 15, 'bold'), bd=5, relief=GROOVE)
...
#         lbl_gender = Label(Manage_frame, text='Gender:', bg='lightgrey', fg='black', font=('times new roman', 18, 'bold'))
...
#         self.txt_address = Text(Manage_frame, font=('times new roman', 15, 'bold'), bd=5, relief=GROOVE, height=3)
...
#         btn_frame.place(x=20,y=555,width=420)
...
#         Detail_frame.place(x=550,y=120,width=925,height=650)

#         Label_search = Label(Detail_frame,text="Search By",bg="lightgrey", fg='black', font=('times new roman',20,'bold'))
...
#         searchbtn = Button(Detail_frame,text='Search',width=10, pady=2).grid(row=0,column=3,pady=10,padx=10)
#         searchbtn = Button(Detail_frame,text='Search All',width=10, pady=5).grid(row=0,column=4,pady=10,padx=10)

        
#          # =======================Table Frame================
#         Table_frame = Frame(Detail_frame, bd=4, relief="ridge", bg='lightgrey')
#         Table_frame.place(x=10,y=70,width=870,height=540)
